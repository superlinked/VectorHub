...
If you have a website with browsable products, your visitors generate a virtual flood of **clickstream data**. With just a little preprocessing, creating embedding using users' click data enables you to create an effective recSys.
...
In our example below, we show you how to take advantage of clickstream data generated by browsing activity on a hotel booking website by turning it into ... recSys.
 ...
 visitors browsing a hotel booking website might produce the following data:
