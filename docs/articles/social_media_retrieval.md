...
If, before continuing, you want to refamiliarize yourself with the **basics of RAG systems**, we encourage you to check out this excellent article on VectorHub: [Retrieval Augmented Generation](retrieval-augmented-generation).
