...
Rriting mathematical expressions with [Latex](https://docs.github.com/en/get-started/writing-on-github/working-with-advanced-formatting/writing-mathematical-expressions).
...
Citation goes immediately underneath the visual element it refers to. Provide a hyperlink for the whole citation, pointing to the source. 
